-- MICRO DESAFIO  1:
-- Utilizando la base de datos de películas queremos conocer, por un lado, los títulos y el nombre del género de todas las series de la base de datos.
...
FROM series 
INNER JOIN seasons ON serie_id = series.id GROUP BY series.title;
